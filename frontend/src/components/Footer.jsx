        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <h3 className="text-xl font-bold">Adel's Store</h3>
            </div>
            <p className="text-gray-300 text-sm leading-relaxed">
              Your trusted destination for quality products. We provide exceptional shopping experience with secure payments and fast delivery.
            </p>
          ...
          <div className="space-y-4">
            ...
            <div className="flex">
              <input
                ...
                className="flex-1 px-3 py-2 text-gray-900 text-sm rounded-l-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-gray-400 text-sm">
              © {currentYear} Adel's Store. All rights reserved.
            </div>
